...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cad_posicao = QWidget()
        self.cad_posicao.setObjectName(u"cad_posicao")
        self.verticalLayout_8 = QVBoxLayout(self.cad_posicao)
        self.verticalLayout_8.setObjectName(u"verticalLayout_8")
        self.horizontalLayout_6 = QHBoxLayout()
        self.horizontalLayout_6.setObjectName(u"horizontalLayout_6")
        self.tbl_posicao = QTreeWidget(self.cad_posicao)
        self.tbl_posicao.setObjectName(u"tbl_posicao")

        self.horizontalLayout_6.addWidget(self.tbl_posicao)

        self.frame_7 = QFrame(self.cad_posicao)
        self.frame_7.setObjectName(u"frame_7")
        self.frame_7.setFrameShape(QFrame.StyledPanel)
        self.frame_7.setFrameShadow(QFrame.Raised)
        self.verticalLayout_7 = QVBoxLayout(self.frame_7)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.btn_incluir_posicao = QPushButton(self.frame_7)
        self.btn_incluir_posicao.setObjectName(u"btn_incluir_posicao")
        sizePolicy.setHeightForWidth(self.btn_incluir_posicao.sizePolicy().hasHeightForWidth())
        self.btn_incluir_posicao.setSizePolicy(sizePolicy)
        self.btn_incluir_posicao.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_incluir_posicao.setStyleSheet(u"")

        self.verticalLayout_7.addWidget(self.btn_incluir_posicao)

        self.btn_alterar_posicao = QPushButton(self.frame_7)
        self.btn_alterar_posicao.setObjectName(u"btn_alterar_posicao")
        sizePolicy.setHeightForWidth(self.btn_alterar_posicao.sizePolicy().hasHeightForWidth())
        self.btn_alterar_posicao.setSizePolicy(sizePolicy)
        self.btn_alterar_posicao.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_alterar_posicao.setStyleSheet(u"")

        self.verticalLayout_7.addWidget(self.btn_alterar_posicao)

        self.btn_excluir_posicao = QPushButton(self.frame_7)
        self.btn_excluir_posicao.setObjectName(u"btn_excluir_posicao")
        sizePolicy.setHeightForWidth(self.btn_excluir_posicao.sizePolicy().hasHeightForWidth())
        self.btn_excluir_posicao.setSizePolicy(sizePolicy)
        self.btn_excluir_posicao.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_excluir_posicao.setStyleSheet(u"")

        self.verticalLayout_7.addWidget(self.btn_excluir_posicao)
        ...
        self.qtab_cadastro.addTab(self.cad_posicao, "")
        ...
        self.pg_treinos = QWidget()
        self.pg_treinos.setObjectName(u"pg_treinos")
        self.label_9 = QLabel(self.pg_treinos)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(220, 130, 381, 81))
        self.pages.addWidget(self.pg_treinos)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtreewidgetitem1 = self.tbl_posicao.headerItem()
        ...
        self.btn_incluir_posicao.setText(QCoreApplication.translate("MainWindow", u"Incluir", None))
        self.btn_alterar_posicao.setText(QCoreApplication.translate("MainWindow", u"Alterar", None))
        self.btn_excluir_posicao.setText(QCoreApplication.translate("MainWindow", u"Excluir", None))
        self.qtab_cadastro.setTabText(self.qtab_cadastro.indexOf(self.cad_posicao), QCoreApplication.translate("MainWindow", u"Posi\u00e7\u00f5es", None))
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:26pt;\">P\u00e1gina de treinos</span></p></body></html>", None))
